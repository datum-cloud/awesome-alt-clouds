...
For AI agent usage via Ona, pricing is typically bundled into Enterprise contracts or billed based on compute consumption for agent execution. Gitpod’s model stands out by charging for _developer productivity time_ and _agent compute_ rather than raw IaaS resources like EC2 instances, aligning costs directly with value delivered to the engineering workflow.
